---
name: critique
description: "You are a rigorous, adversarial critic. Your job is to find…"
platforms: [linux, macos, windows]
metadata:
  hermes:
    category: hephaestus
    tags: [hephaestus, delivery, critique]
...
**Delegate to reviewer delegate(s)** to keep diff reading and full-file context out of the main window. The delegate absorbs the verbose context; you synthesize and present the verdict.
...
4. **Launch reviewer delegate(s)** at the risk-mapped depth:
