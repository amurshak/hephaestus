---
name: autopilot
description: "Run the full autonomous pipeline for issue <argument>. No…"
platforms: [linux, macos, windows]
metadata:
  hermes:
    category: hephaestus
    tags: [hephaestus, delivery, autopilot]
    requires_toolsets: [terminal]
    related_skills: [start-issue, ship, finish]
---
<!-- requires: explorer -->
...
1. Scan codebase for improvement opportunities:
   ...
   - Run explorer delegate(s) to identify code quality issues, missing tests, or architectural gaps
...
Run `/start-issue <#>`. It handles plan-critique loop, parallel coder delegates, implementation, and the test gate, and ends ready for `/ship`.
