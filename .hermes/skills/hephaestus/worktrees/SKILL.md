---
name: worktrees
description: "Orchestrate parallel multi-session development: survey…"
platforms: [linux, macos, windows]
metadata:
  hermes:
    category: hephaestus
    tags: [hephaestus, delivery, worktrees]
...
> **Hermes:** this skill is the `/worktrees` adapter.
...
tell application "Terminal"
  activate
  do script "cd <worktree> && hermes chat -s hephaestus/start-issue -q \"Run the start-issue workflow for issue <N>.\""
