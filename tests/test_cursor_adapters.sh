...
assert_contains "orient chain note names the reaper" "$(cat "$orient")" "Invoke nested workflows as slash commands (/worktrees)"
assert_not_contains "update-docs declares no chains inline" "$(cat "$HEPHAESTUS_ROOT/.cursor/commands/update-docs.md")" "Invoke nested workflows"
