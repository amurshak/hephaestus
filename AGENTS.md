...
- Confirm Codex loads project skills and still takes the positional-prompt spawn form with `bash scripts/verify-codex-load.sh`; pass a project path to check an installed project.
